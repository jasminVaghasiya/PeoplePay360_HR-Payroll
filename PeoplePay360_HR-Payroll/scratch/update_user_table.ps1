$file = "c:/Users/01/OneDrive/Desktop/prompt/PeoplePay360_HR-Payroll/frontend/src/modules/auth/UserManagementView.jsx"
$tmp = "$file.tmp"
...
Write-Host "Updated UserManagementView.jsx table to match requested design!"
