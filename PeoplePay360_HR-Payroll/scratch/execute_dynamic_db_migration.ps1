$fileProfile = "c:/Users/01/OneDrive/Desktop/prompt/PeoplePay360_HR-Payroll/frontend/src/modules/auth/UserProfileDetailModal.jsx"
$tmpProfile = "$fileProfile.tmp"
...
[System.IO.File]::WriteAllText($tmpProfile, $contentProfile)
Move-Item -Path $tmpProfile -Destination $fileProfile -Force
Write-Host "Updated UserProfileDetailModal.jsx to be 100% database driven!"
